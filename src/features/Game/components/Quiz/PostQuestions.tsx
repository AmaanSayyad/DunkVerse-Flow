...
const PostQuestions = () => {
  ...
  const claimReward = async () => {
    ...
    setLoading(true);
    try {
      const nftContractAddress = '0xa35Bd929a3554bf07908e3131a7Df305849Cd25F'; // AIGeneratedNFT contract address
      ...
      const tx = await nftContractInstance['safeTransferFrom(address,address,uint256)'](
        '0xa35Bd929a3554bf07908e3131a7Df305849Cd25F', // Replace with the actual address holding the NFT
